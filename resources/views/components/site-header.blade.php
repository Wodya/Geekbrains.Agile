            ...
            <div class="main-nav-wrapper">
                <div class="header-left">
                    <nav id="primary-menu" class="main-nav">
                        <ul class="nav">
                            <li class="active menu-item menu-home"><a href="index.html">На главную</a>
                                <ul class="sub-menu">
                                    <li class="menu-item"><a href="index.html">Блог садовода</a>
                                        <ul class="sub-menu">
                                            <li class="menu-item"><a href="index.html">Календарь работ</a></li>
                                            <li class="menu-item"><a href="home-2.html">Питание и защита</a></li>
                                            <li class="menu-item"><a href="home-3.html">Почва</a></li>
                                            <li class="menu-item"><a href="home-4.html">Лунный календарь</a></li>
                                        </ul>
                                    </li>
                            ...
                            <li class="menu-item menu-shop"><a href="product-shop.html">Магазин</a>
                                <ul class="sub-menu">
