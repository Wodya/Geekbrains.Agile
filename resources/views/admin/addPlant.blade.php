...
<div class="col-md-4  offset-2">
    <form method="post" @if(empty($plants)) action="{{route('admin::plants::create')}}" @else
        action="{{route('admin::plants::update', ['id' => $plants->id])}}" @endif enctype="multipart/form-data">
                    ...
                    <div class="col-md-5">
                        <div class="single-product-slider">
                            <div id="sync1" class="owl-carousel owl-template">
                                ...
                                {{--                                        <div class="item">--}}
                                {{--                                            <figure><img src="/Images/Big/{{$plants->photoBigPath ?? ''}}"
                                alt="slide"--}}
                            ...
                            <div class="summary-product entry-summary">
                                ...
                                <div class="product-single-short-description">
                                    <p><input id="shortInfo" type="text" class="form-control" name="shortInfo"
                                            placeholder="shortInfo" value="{{$plants->shortInfo ?? ''}}"></p>
                                </div>
                                ...
                                <div class="product_meta" style="margin-top: 30px;">
                                    <span class="product-stock-status-wrapper" style="display: flex;">
                                        ...
                                        <span class="product-stock-status in-stock">
                                            <input id="start" type="date" class="form-control" name="addDate"
                                                placeholder="addDate" value="{{$plants->addDate ?? ''}}"
                                    ...
                                    <span class="posted_in" style="display: flex;">
                                        ...
                                        <input id="wateringDays" type="number" value="{{$plants->wateringDays ?? ''}}"
                                            name="wateringDays">
                                    ...
                                    <span class="posted_in" style="display: flex;">
                                        ...
                                        <input id="wateringDays" type="number" value="{{$plants->manuringDays ?? ''}}"
                                            name="manuringDays">
                                    </span>
                                    <span class="posted_in" style="display: flex;">
                                    ...
                                    <span class="posted_in" style="display: flex;">
                                        ...
                                        <ul>
                                            ...
                                            <li><input type="checkbox" name="tag{{$key}}" value="{{$tag}}"
                                                    @if(!empty($plantTags)) @foreach ($plantTags as $tagPlants)
                                                    @if($tag==$tagPlants)checked @endif @endforeach @endif>{{$tag}}</li>
                                            @empty
                                            <p>Тегов нет</p>
                                            @endforelse
        ...
        <br /><input class="btn btn-primary" style="float: right" type="submit" value="Сохранить"><br><br><br><br>
